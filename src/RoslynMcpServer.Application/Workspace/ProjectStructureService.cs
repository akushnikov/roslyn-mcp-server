...
public sealed class ProjectStructureService(
    ProjectStructureQueryOperation operation) : IProjectStructureService
{
    /// <inheritdoc />
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return QueryResultMapper.Map(
            ...
            static error => new GetProjectStructureResult(
                Workspace: null,
                Projects: Array.Empty<ProjectStructureDescriptor>(),
                FailureReason: error.FailureReason,
                Guidance: error.Guidance),
            static () => new GetProjectStructureResult(
                Workspace: null,
                Projects: Array.Empty<ProjectStructureDescriptor>(),
